...
install_dnsmasq(){
    ...
    download /etc/dnsmasq.d/custom_netflix.conf ${DNS_SERVICE_ONEKEY_RAW_BASE:-https://raw.githubusercontent.com/1660667086/dns-service-onekey/main}/upstream/dnsmasq.conf
    download /tmp/proxy-domains.txt ${DNS_SERVICE_ONEKEY_RAW_BASE:-https://raw.githubusercontent.com/1660667086/dns-service-onekey/main}/upstream/proxy-domains.txt
...
install_sniproxy(){
    ...
    if check_sys packageManager yum; then
        if [[ ${fastmode} = "1" ]]; then
            if [[ ${bit} = "x86_64" ]]; then
                download /tmp/sniproxy-0.6.1-1.el8.x86_64.rpm ${DNS_SERVICE_ONEKEY_RAW_BASE:-https://raw.githubusercontent.com/1660667086/dns-service-onekey/main}/upstream/sniproxy/sniproxy-0.6.1-1.el8.x86_64.rpm
        ...
        if centosversion 6; then
            ...
            download /etc/systemd/system/sniproxy.service ${DNS_SERVICE_ONEKEY_RAW_BASE:-https://raw.githubusercontent.com/1660667086/dns-service-onekey/main}/upstream/sniproxy.service
        ...
        if [[ ${fastmode} = "1" ]]; then
            if [[ ${bit} = "x86_64" ]]; then
                download /tmp/sniproxy_0.6.1_amd64.deb ${DNS_SERVICE_ONEKEY_RAW_BASE:-https://raw.githubusercontent.com/1660667086/dns-service-onekey/main}/upstream/sniproxy/sniproxy_0.6.1_amd64.deb
    ...
    download /etc/sniproxy.conf ${DNS_SERVICE_ONEKEY_RAW_BASE:-https://raw.githubusercontent.com/1660667086/dns-service-onekey/main}/upstream/sniproxy.conf
    download /tmp/sniproxy-domains.txt ${DNS_SERVICE_ONEKEY_RAW_BASE:-https://raw.githubusercontent.com/1660667086/dns-service-onekey/main}/upstream/proxy-domains.txt
